...
const fload = { key : { message: `Queen-Sakura` + `\nDark-Hyper`, thumbnail: await (await fetch(pp)).buffer(), sellerJid: '0@s.whatsapp.net' }}
...
await conn.reply(m.chat, menu, a, { contextInfo: { externalAdReply: {title: 'Hello', body: saludo, sourceUrl: ig, thumbnail: await (await fetch(pp)).buffer() }}})
